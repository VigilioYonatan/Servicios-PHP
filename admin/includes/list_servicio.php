...
<?php if($_SESSION['role'] != 5){
  ...
  ?>
    ...
    <main class="app-content">
      ...
      <label for=""><?php echo $_GET['ruc']; ?></label>
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
                    ...
                    <tbody align="center">
                     <tr>
                       ...
                       <td >S/.<?php echo $pro_pventa; ?></td>
                           ...
                           <td class="delete"><a href="index.php?action=tabla_id&cod_codigo=<?php echo $codigo; ?>&ser_codigo=<?php echo $pro_cod; ?>" ><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a></td>
