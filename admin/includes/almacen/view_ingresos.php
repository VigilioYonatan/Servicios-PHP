...
?>
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-users"></i>LISTA DE INGRESOS</h1>
      </div>
            ...
            <form action="" method="post" enctype="multipart/form-data">
              <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered">
                  ...
                  <?php
                  $all_cli = mysqli_query($conexion, "select * from ingresos order by id_ingresos");
                  $i = 1;

                  while ($row = mysqli_fetch_array($all_cli)) {
                    $ing_codigo = $row['codigo_ingresos'];
                  ?>

                    <tbody align="center">
                      <tr>
                        <td><a href="index.php?action=view_ingresos_id&ing_cod=<?php echo $ing_codigo; ?>"style="color:#1F618D;font-weight: bold;"><?php echo $ing_codigo; ?></a></td>
                        <td><?php echo $row['nombre_ingresos']; ?></td>
                        <td><?php echo $row['fabricante_ingresos']; ?></td>
                        <td><?php echo $row['modelo_ingresos']; ?></td>
                        <td><?php echo $row['categoria_ingresos']; ?></td>
                        <td><?php echo $row['lote_ingresos']; ?></td>
                        <td><?php echo $row['unidades_ingresos']; ?></td>
    ...
    <a href="index.php?action=add_ingresos" class="btn btn-success"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Agregar Ingresos</a>
  </main>
