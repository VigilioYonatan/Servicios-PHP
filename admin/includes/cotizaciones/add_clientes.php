              ...
              <div class="col-lg-4 offset-lg-1">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Area:</label>
                       <input class="form-control" type="text"  name="area" placeholder="area" required >
                  </div>
                  <div class="form-group">
...
if(isset($_POST['agregarCli'])){
    ...
    $addServ = mysqli_query($conexion, "insert into clientes(ruc_cliente,razon_cliente,direccion_cliente,contacto_cliente,celular1_cliente,celular2_cliente,email1_cliente,email2_cliente,web_cliente,area_cliente,estado_cliente,asignado_cliente) values('$ruc','$razon','$direccion','$contacto','$celular1','$celular2','$email1','$email2','$web','$area','$estado','$asignado')");
