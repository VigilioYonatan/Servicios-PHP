                    ...
                    <tbody align="center">
                      <tr>
                       ...
                       <td> <input type="text" name="nombre" value="<?php echo $row['cotizacion_nombre']; ?>" disabled></td>
                           ...
                           <td class="delete"><a id="pagina_pequeña" href="index.php?action=edit_estado_id&edit_pago=<?php echo $row['cotizacion_id']; ?>" ><i class="fa fa-pencil fa-2x" aria-hidden="true"></i></a></td>
